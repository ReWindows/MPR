//! Windissect-generated Rust FFI bindings for MPR.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "9F841B04F37F7332CD5AE4751DAAFA23";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2433114060;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 8] = [77, 80, 82, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2433114060 { return 0; }
