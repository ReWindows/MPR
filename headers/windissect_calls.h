...
static constexpr wchar_t module_name[8] = {0x004D, 0x0050, 0x0052, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 2433114060U || rva >= image_size) return nullptr;
return base + rva;
}
